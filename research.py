...
TECH_TREE = [
    ...
    {"id":"industrial_smelting","name":"Industrial Electric Furnace","description":"Industrial Electric Furnace (3×3) — purified_gold → liquid_gold. 200 kME/s power draw. Unlocks Alloyer and Foundry.","cost":1500,"unlocks":[57],"requires":["gold_refining"],"tier":7,"branch":"refining"},
    ...
    {"id":"coal_power","name":"Coal Generator","description":"Coal Generator (2×2) — 7 kME/s from coal. Dirty but available from the start.","cost":15,"unlocks":[12],"requires":[],"tier":1,"branch":"power"},
    {"id":"wind_energy","name":"Wind Turbine 1","description":"Wind Turbine 1 (2×2) — 1.5 kME/s clean power. Start of the wind and solar upgrade paths.","cost":30,"unlocks":[26],"requires":[],"tier":1,"branch":"power"},
    ...
    {"id":"energy_storage","name":"MV Battery","description":"MV Battery (2×2) — 10 MME capacity, 50 kME/s transfer. Buffers power across demand spikes.","cost":220,"unlocks":[100],"requires":["mv_poles"],"tier":3,"branch":"power"},
    ...
    {"id":"steam_power","name":"Steam Turbine","description":"Steam Turbine (3×3) — 500 kME/s from steam. Pair with Electric Water Heater. Required for Coal Power Plant.","cost":350,"unlocks":[106],"requires":["mv_poles"],"tier":3,"branch":"power"},
    ...
    {"id":"diesel_generation","name":"Diesel Generator","description":"Diesel Generator (2×1) — 90 kME/s on diesel; 78 kME/s on PQD. Needs diesel fuel from the Refining tree.","cost":500,"unlocks":[17],"requires":["mv_poles"],"tier":3,"branch":"power"},
    {"id":"wind_turbine_2","name":"Wind Turbine 2","description":"Wind Turbine 2 (2×2) — 16 kME/s, ~10× Wind Turbine 1. Good mid-game clean power.","cost":600,"unlocks":[27],"requires":["wind_energy","mv_poles"],"tier":3,"branch":"power"},
    {"id":"hv_power","name":"HV Power Network","description":"HV Pole (2×2, 10-tile range) + HV Battery (2×2, 100 MME) + HV Transformer (2×3) — planetary-scale power distribution.","cost":2000,"unlocks":[99,101,102],"requires":["energy_storage"],"tier":4,"branch":"power"},
    {"id":"gasoline_power","name":"Gasoline Generator","description":"Gasoline Generator (2×2) — 120 kME/s on gasoline. Highest output generator. Needs gasoline from Production or Refining.","cost":600,"unlocks":[107],"requires":["diesel_generation"],"tier":4,"branch":"power"},
    ...
    {"id":"wind_turbine_3","name":"Wind Turbine 3","description":"Wind Turbine 3 (3×3) — 50 kME/s clean power. Top of the wind path.","cost":2500,"unlocks":[28],"requires":["wind_turbine_2"],"tier":4,"branch":"power"},
    {"id":"coal_power_plant","name":"Coal Power Plant","description":"Coal Power Plant (12×12) — 500 MME/s from coal + water. Requires HV grid to distribute. Massive build cost.","cost":2500,"unlocks":[108],"requires":["steam_power","hv_power"],"tier":5,"branch":"power"},
    {"id":"nuclear_power","name":"Nuclear Power Plant","description":"Nuclear Power Plant (16×16) — 1.32 GME/s from fuel_rod + distilled_water + control_rod. Fuel rods come from the Refining tree.","cost":5000,"unlocks":[96],"requires":["coal_power_plant"],"tier":5,"branch":"power"},
]
